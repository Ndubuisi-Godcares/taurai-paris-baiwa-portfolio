...
export default function Footer() {
  return (
    <footer className="border-t border-[#1a2940] py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm">
        <p className="font-mono text-slate-500">
          <span className="text-cyan-400">TPB</span> · Built with Next.js &amp; Tailwind CSS
        </p>
        ...
        <p className="font-mono text-slate-600 text-xs">© 2026 Taurai Paris Baiwa</p>
      </div>
    </footer>
  )
}
